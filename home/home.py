...
with st.container():
    ...
    with leftCol:
        ...
        With our web application user can analyze stocks of various companies listed in various
        indexes along with getting news feed based on the preferences. And can get the future 
        predicitons as well.
